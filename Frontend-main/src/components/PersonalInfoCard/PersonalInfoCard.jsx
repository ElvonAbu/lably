...
function PersonalInfoCard({ onNext, onClose, initialValues, bookingFor = "myself" }) {
  ...
  const isForSomeoneElse = bookingFor === "someone";
      ...
      <div className="personal-info-card" onClick={(e) => e.stopPropagation()}>
        <div className="personal-info-card-inner">
          <h2 className="personal-info-title">
            {isForSomeoneElse ? "Enter Their Information" : "Enter Your Information"}
          </h2>

          <p className="personal-info-subtitle">
            {isForSomeoneElse
              ? "This helps us match the person you're booking for with the right scientist and care for them properly."
              : "This helps us match you with the right scientist and care for you properly."}
          </p>

          <div className="personal-info-field">
            <label className="personal-info-label">
              {isForSomeoneElse ? "Their full name" : "Full name"}
            </label>
            <input
              type="text"
              className="personal-info-input"
              placeholder={isForSomeoneElse ? "Enter their full name" : "Enter your full name"}
              value={name}
          ...
          <div className="personal-info-field">
            <label className="personal-info-label">
              {isForSomeoneElse ? "Their date of birth" : "Date of birth"}
            </label>
          ...
          <div className="personal-info-field">
            <label className="personal-info-label">
              {isForSomeoneElse ? "Their gender" : "Gender"}
            </label>
          ...
          <div className="personal-info-field">
            <label className="personal-info-label">
              {isForSomeoneElse
                ? "Any relevant medical history for them? (optional)"
          ...
          <div className="personal-info-notice">
            ...
            <span>
              {isForSomeoneElse ? "Their" : "Your"} health data is encrypted and securely stored in compliance with the
              Nigeria Data Protection Act (NDPA) 2023. Access is limited to authorized
              healthcare providers directly involved in {isForSomeoneElse ? "their" : "your"} care.
            </span>
          </div>
